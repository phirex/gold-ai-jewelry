...
export default function DesignPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-bg-primary">
      ...
      <main className="flex-1 py-4 md:py-6 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <h1 className="font-display text-2xl md:text-3xl font-bold text-center mb-4 md:mb-6 text-gradient animate-fade-in-down">
            {t("title")}
          </h1>
